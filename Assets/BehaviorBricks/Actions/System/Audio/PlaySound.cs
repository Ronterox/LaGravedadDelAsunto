...
namespace BehaviorBricks.Actions.System.Audio
{
    /// <summary>
    ...
    public class PlaySound : GOAction
    {
        ...
        ///<value>Whether the action waits till the end of the clip to be completed.</value>
        ...
        /// <remarks>Associate the sound clip and initializes the elapsed time.</remarks>
