...
namespace BehaviorBricks.Actions.System.Animation
{
    /// <summary>
    ...
    public class PlayAnimation : GOAction
    {
        ...
        {
            var animation = gameObject.GetComponent<UnityEngine.Animation>();
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (!waitUntilFinish || elapsedTime >= animationClip.length - crossFadeTime) return TaskStatus.COMPLETED;
